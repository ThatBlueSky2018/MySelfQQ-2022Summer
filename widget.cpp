    ...
    ui(new Ui::Widget)
{
    ...
    //加粗
    connect(ui->boldTBtn,&QToolButton::clicked,this,[=](bool isCheck){
        if(isCheck)
        {
    ...
    //倾斜
    connect(ui->italicTBtn,&QToolButton::clicked,this,[=](bool check){

        ui->msgTxtEdit->setFontItalic(check);
    });

    //下划线
    connect(ui->underlineTbtn,&QToolButton::clicked,this,[=](bool check){
...
void Widget::usrLeft(QString usrname,QString time)
{
    ...
    if(!isEmpty)
    {
        ...
        ui->msgBrowser->append(QString("%1于%2 离开").arg(usrname).arg(time));
        //在线人数更新
